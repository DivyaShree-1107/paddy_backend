...
exports. signup= function(req, res){
  ...
  text: `Successfully registered to APMC.`
  };
...
exports.changepassword = (req, res)=> {
  ...
  return res.status(200).json({token: token, userId: loadedUser._id.toString(), email: loadedUser.email , role: loadedUser.role,Firstname: loadedUser.Firstname})
  })
  .catch(err => {
  if (!err.statusCode) {
  err.statusCode = 500;
